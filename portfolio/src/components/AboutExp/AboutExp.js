...
<div className="aboutExperience">
	...
	<div className="exps1">
		<h1 className="title">Experience</h1>
			<p className="e-title-2">Social Media Coordinator - Sheridan College</p>
				...
				<p>I was responsible for communicating events and opportunities to students in the Advertising and Marketing Communications program.
	...
	<div className="exps">
			<p className="e-title-2">PAL Student Tutor - Sheridan College</p>
				...
				<p>Responsible for tutoring, teaching and aiding students at Sheridan College, during my winter semester term in 2019.
