...
<div className="aboutEducation">
	...
	<h1 className="title">Education</h1>
		...
		<p>Creating, managing and developing web and mobile content. Learning and focused on interactivity, front-end coding, social media, user experience (UX) and emerging mobile technologies.
	...
	<div className="edu">
		...
		<p>Focused on the world of Advertising & Marketing Communications. In this program, I learned foundational advertising knowledge, media development, creative and account management.
